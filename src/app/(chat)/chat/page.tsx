	...
	return (
		<div className="max-w-6xl mx-auto space-y-8 py-8 px-4">
			<div className="space-y-4">
				<h1 className="text-4xl font-bold tracking-tight">EduAI Playground</h1>
				<p className="text-muted-foreground text-lg">
					Ingest course notes, search with courseId isolation, and chat with the
					student RAG agent. Built for a hackathon-speed prototype.
				</p>
			</div>
